...
const ActionColumn = ({ row }) => {
  const INIT_PROYECTO = {
    ...
    CantInicial: row.cells[5].value ? row.cells[5].value : row.cells[5].value,
    CantFinal: row.cells[6].value ? row.cells[6].value : row.cells[6].value,
    Categoria: row.cells[7].value ? row.cells[7].value : row.cells[7].value,
    Estado: row.cells[8].value ? row.cells[8].value : row.cells[8].value,
