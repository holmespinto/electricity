	...
	return;
		...
		switch ($_POST['opcion']) {
			...
			case 'add':
					...
					//VERIFICO
						if($id>0){
								$msg[] = array('id'=>1,'menssage'=>'El Cliente fue registrado correctamente!');
						}else{
			...
			case 'update':
					$chartic=array();
					//LLAMO LA TABLA
					$tbl_categorias='electry_clientes';
						...
						$msg[] = array('menssage'=>'OK. El Cliente '.$_POST['id'].'-'.$_POST['nombres'].' fue actualizado correctamente!');
						$var = var2js($msg);	
						echo $var;				
			...
			case 'delete':
					...
					sql_delete("electry_clientes","id=" . intval($_POST['id']));
